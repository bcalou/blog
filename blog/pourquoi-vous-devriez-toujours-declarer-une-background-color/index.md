...
{% blockquote
  "Je me souviens des années 90 où la plupart des navigateurs avaient une couleur de fond grise. Internet Explorer était le seul à avoir un fond blanc par défaut. Les autres ont suivi.",
  "Raphael Schweikert",
...
- Ne rien spécifier etr avoir un design extrêmement simple qui s'adaptera aux couleurs définies par le navigateur
