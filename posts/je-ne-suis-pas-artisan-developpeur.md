...
<figure>
  {% img "artisan/manifeste.png", "Capture d'écran du manifeste de l'artisan développeur" %}
...
<figure>
  {% img "artisan/violoncelle.png", "La couverture du livre The Software Craftsman" %}
...
<figure>
  {% img "artisan/dieu.jpg", "Un homme levant ses bras vers le ciel" %}
...
<figure>
  {% img "artisan/code-review.png", "Strip : comment faire une bonne revue de code" %}
...
<figure>
  {% img "artisan/software-craftmanship.jpg", "Une imagerie soviétique de l'artisan développeur" %}
